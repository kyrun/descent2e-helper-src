...
public class SkillDef : BaseDef<SkillDef>, IHasReminder
{
	...
	[SerializeField] List<ReminderPrerequisite.Type> _reminderPrerequisites = default;
	...
	public IEnumerable<ReminderPrerequisite.Type> ReminderPrerequisites { get { return _reminderPrerequisites; } }
}
